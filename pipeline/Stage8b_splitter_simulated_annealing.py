...
Simulated Annealing:
  ...
  - Low temperature: Only accepts improvements
    ...
    # --sample-rate instead of substring-matching "44" in --dataset.
    ...
    if args.from_splits:
        ...
        if stats_file.exists():
            ...
            if saved_dataset_path:
                ...
                # stale hardcoded sentinel comparison; now an explicit flag
                # captured before --dataset's default was resolved).
