...
Genetic Algorithm:
  ...
  - Elitism: Best solutions carry to next generation
    ...
    if verbose:
        print("="*80)
        print("STAGE 8b: DATASET SPLITTING - GENETIC ALGORITHM (GA)")
        print("="*80)
        print("WHAT THIS DOES:")
        print("  - Creates optimal train/val/test splits using genetic algorithm")
        print("  - Ensures source-based separation (prevents data leakage)")
        print("  - Achieves near-perfect target ratios through evolution")
        print("  - Slower than MIP but still finds optimal solutions")
        print()
        print("INPUT:")
