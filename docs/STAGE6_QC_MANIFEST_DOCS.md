...
`pipeline/Stage6_clip_qc_manifest.py` analyses every extracted WAV clip, runs quality
...
python pipeline/Stage6_clip_qc_manifest.py

# Custom paths
python pipeline/Stage6_clip_qc_manifest.py /path/to/extracted_segments \
