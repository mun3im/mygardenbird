...
**`file_id`** is the normalised clip primary key matching the `file_id` column in
`clips.csv` (Stage 7). The WAV filename is derived as:
`xc{file_id[2:]}.wav` — e.g. `XC1002657_2860` → `xc1002657_2860.wav`.
